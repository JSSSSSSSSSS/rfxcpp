...
{
public:
    static void encode(DwtSubBands & sub_bands, std::span<const int> quantization_values);
    static void decode(DwtSubBands & sub_bands, std::span<const int> quantization_values);
private:
